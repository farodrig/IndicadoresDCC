...
class Metricas_library
{
	...
	function initialize($parameters)
	{
		...
		$this->met_org = element('met_org', $parameters);
    	$this->state = element('state', $parameters);
		...
		$this->updater = element('updater', $parameters);
		$this->dateup = element('dateup', $parameters);
    	$this->validator = element('validator', $parameters);
		$this->dateval = element('dateval', $parameters);
		return $this;
	}
 /**
     * @return the $id
