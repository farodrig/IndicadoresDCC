...
START TRANSACTION;
USE `UDashboard`;
INSERT INTO `UDashboard`.`State` (`id`, `name`) VALUES (1, 'no_validado');
INSERT INTO `UDashboard`.`State` (`id`, `name`) VALUES (2, 'validado');
INSERT INTO `UDashboard`.`State` (`id`, `name`) VALUES (3, 'por_borrar');
