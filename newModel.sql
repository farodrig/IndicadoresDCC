...
INSERT INTO `UDashboard`.`Unit` (`id`, `name`) VALUES (1, 'Pesos');

COMMIT;


-- -----------------------------------------------------
-- Data for table `UDashboard`.`Metric`
-- -----------------------------------------------------
START TRANSACTION;
USE `UDashboard`;
INSERT INTO `UDashboard`.`Metric` (`id`, `category`, `name`, `y_unit`, `y_name`, `x_unit`, `x_name`) VALUES (1, 2, 'Gasto Anual', 1, 'Gastos', 0, '');
